...
3. Planned commands after promotion:
   ...
   - `mix credo --strict`
   - `mix test`
4. Keep `origin` intended for `stakeholder-circus/elixir-stakeholder` and `upstream` pointed at `https://github.com/giacomo-b/rust-stakeholder`.
